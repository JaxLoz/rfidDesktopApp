 ...
 * @author C.Mateo
 */
public class StudentControllerV2 implements ActionListener, ISerialComunication {

    private final StudentForm studentForm;
    private final StudentDao studentDao;

    public StudentControllerV2(StudentDao studentDAO, StudentForm studentForm) {
