...
public class LightDarkMode extends JPanel {
    ...
    private void init() {
        ...
        buttonLight = new JButton("Light", new FlatSVGIcon(getClass().getResource("/icon/svg/light.svg")));
        buttonDark = new JButton("Dark", new FlatSVGIcon(getClass().getResource("/icon/svg/dark.svg")));
    ...
    private void checkStyle() {
        ...
        if (isDark) {
            buttonLighDark.setIcon(new FlatSVGIcon(getClass().getResource("/icon/svg/dark.svg")));
        } else {
            buttonLighDark.setIcon(new FlatSVGIcon(getClass().getResource("/icon/svg/light.svg")));
        }
    }
